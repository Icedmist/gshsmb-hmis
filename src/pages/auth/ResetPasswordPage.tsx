...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // With Firebase, password reset is done via the email link
      // This page is now simplified - the actual reset happens via Firebase's built-in flow
      setSuccess(true);
            ...
            {success ? (
              ...
              <>
                <div className="mb-6">
                  ...
                  <p className="text-slate-500 text-sm mt-0.5">Use the link from your email to set a new password</p>
                </div>
