...
export default function LoginPage() {
  ...
  useEffect(() => {
    api.get('/public/stats').then((data: any) => {
      setPublicStats({ total_hospitals: data.total_hospitals, total_departments: data.total_departments, total_employees: data.total_employees });
    }).catch(() => {});
  }, []);
