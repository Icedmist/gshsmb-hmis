            ...
            {success ? (
              <div className="text-center py-4 space-y-4">
                ...
                <p className="text-sm text-slate-500 leading-relaxed">
                  If an account exists with <strong className="text-slate-700">{email}</strong>,
                  we've sent a password reset code to your registered email and phone number.
                </p>
                <Link
                  to="/reset-password"
              ...
              <>
                <div className="mb-6">
                  ...
                  <p className="text-slate-500 text-sm mt-0.5">Enter your email to receive a reset code</p>
                </div>
